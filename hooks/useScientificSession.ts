...
export const useScientificSession = () => {
  ...
  return {
    ...
    isSessionsReady: isMechLoaded && isFlowLoaded && isDoeLoaded && isInceptionLoaded && isDataLoaded && isWritingLoaded && isStructuralLoaded && isTimelineLoaded && isVisionLoaded
  };
};
