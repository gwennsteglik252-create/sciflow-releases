...
export const useTimelineDesigner = (isActive: boolean) => {
    ...
    const handleCategoryChange = (id: string, newCategory: string) => {
        setSavedTimelines(prev => prev.map(s => s.id === id ? { ...s, category: newCategory } : s));
    };
    ...
    return {
        ...
        handleSaveToLibrary, handleConfirmSave, handleLoadFromLibrary, handleDeleteFromLibrary, handleRenameInLibrary, handleCategoryChange,
