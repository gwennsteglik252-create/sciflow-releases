...
export const CropOverlay: React.FC<CropOverlayProps> = ({
    ...
    return (
        ...
        >
            ...
            <div
                className="absolute top-3 left-1/2 -translate-x-1/2 flex items-center gap-1 bg-slate-900/95 backdrop-blur-md px-2 py-1.5 rounded-lg shadow-2xl border border-white/10 no-export"
                style={{ zIndex: 10 }}
            ...
            <div
                className="absolute bottom-3 left-1/2 -translate-x-1/2 flex items-center gap-2 bg-slate-900/95 backdrop-blur-md px-4 py-2 rounded-lg shadow-2xl border border-white/10 no-export"
                style={{ zIndex: 10 }}
                onMouseDown={(e) => e.stopPropagation()}
            >
                <button
