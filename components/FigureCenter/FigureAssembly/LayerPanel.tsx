    ...
    return (
      ...
      `}
        >
            ...
            {showOpacity && (
                <div
                    className="absolute right-0 top-full mt-2 z-[100] bg-slate-900/40 backdrop-blur-2xl border border-white/10 rounded-2xl p-4 w-56 shadow-[0_20px_50px_rgba(0,0,0,0.5)] animate-reveal overflow-visible"
                    onClick={e => e.stopPropagation()}
                >
                    <div className="flex justify-between items-center mb-4">
                        <div className="flex flex-col">
                            <span className="text-[9px] text-white/40 uppercase tracking-widest font-black italic">Alpha Channel</span>
                            <span className="text-[10px] text-indigo-300 font-bold uppercase mt-0.5">Transparency Control</span>
                        </div>
    ...
    return (
        <div className="flex flex-col h-full bg-slate-900/60 backdrop-blur-xl border-l border-white/5 relative overflow-hidden">
            ...
            <div className="relative px-5 py-4 border-b border-white/10 z-10">
                <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-indigo-500/30 to-purple-600/30 border border-white/10 flex items-center justify-center shadow-[0_10px_30px_rgba(79,70,229,0.3)] group cursor-help">
                        ...
                        <div className="flex flex-col">
                            <span className="text-[13px] font-black uppercase tracking-[0.2em] text-white">Figures</span>
                    ...
                    <div className="flex items-center gap-2">
                        <div className="px-3 py-1.5 rounded-xl bg-white/5 border border-white/10 backdrop-blur-md shadow-inner">
                            ...
                            <span className="text-[8px] text-slate-500 font-bold ml-1.5 uppercase">Obj</span>
                        </div>
                    </div>
                </div>
            ...
            <div className="flex items-center gap-2 px-5 py-2.5 bg-white/2 border-b border-white/5 z-10">
                <div className="flex-1 text-[8px] text-slate-500 uppercase tracking-[0.3em] font-black italic">Composition Hierarchy</div>
                <div className="flex items-center gap-1">
                    <div className="w-1.5 h-1.5 rounded-full bg-slate-800 border border-white/10" />
                    <span className="text-[8px] text-slate-600 font-black uppercase tracking-widest">Controls</span>
                </div>
            </div>
            ...
            <div className="border-t border-white/10 px-6 py-5 bg-slate-950/40 z-10">
                <div className="flex justify-between items-center mb-4">
                    <span className="text-[10px] font-black text-white/20 uppercase tracking-[0.4em]">Legend</span>
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div className="flex items-center gap-2.5 group cursor-help">
                        ...
                        <span className="text-[9px] text-slate-400 font-black uppercase tracking-widest">Images</span>
                    </div>
                    <div className="flex items-center gap-2.5 group cursor-help">
                        ...
                        <span className="text-[9px] text-slate-400 font-black uppercase tracking-widest">Labels</span>
                    </div>
                    <div className="flex items-center gap-2.5 group cursor-help">
                        ...
                        <span className="text-[9px] text-slate-400 font-black uppercase tracking-widest">Shapes</span>
                    </div>
                    <div className="flex items-center gap-2.5 group cursor-help">
                        ...
                        <span className="text-[9px] text-slate-400 font-black uppercase tracking-widest">Locked</span>
                    </div>
                </div>
                ...
                <div className="mt-5 flex items-center justify-between pt-4 border-t border-white/5">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-[8px] text-indigo-400/80 font-black uppercase tracking-[0.2em]">Alpha Build</span>
                    </div>
                    <span className="text-[8px] text-slate-600 font-bold italic">Double-click to rename layer</span>
                </div>
            </div>
        </div>
    );
