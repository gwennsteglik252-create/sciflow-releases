          ...
          <div className="space-y-2.5 animate-reveal">
            {[
              ...
              <div key={i} className="group">
                ...
                <textarea
                  className={`w-full h-12 bg-slate-50 border-2 border-transparent rounded-[1.25rem] p-3 text-[10px] font-medium text-slate-700 outline-none shadow-inner resize-none leading-relaxed transition-all focus:bg-white focus:border-${item.color}-100 focus:ring-4 focus:ring-${item.color}-50/50 placeholder:text-slate-300`}
        ...
        {baseImage ? (
          ...
          <>
            <button
              ...
              disabled={isGenerating}
              className={`w-full py-4 mt-6 rounded-[1.5rem] text-[10px] font-black uppercase tracking-[0.2em] shadow-xl transition-all active:scale-95 disabled:opacity-50 flex items-center justify-center gap-2 ${results.length > 0
            ...
            <section className="pt-6 mt-2 border-t-2 border-dashed border-slate-100 animate-reveal">
              ...
              <div
                ...
                className="group border-2 border-dashed border-slate-200 rounded-[2rem] p-5 bg-slate-50/50 hover:bg-white hover:border-indigo-400 hover:shadow-xl transition-all cursor-pointer flex flex-col items-center justify-center gap-2"
              >
