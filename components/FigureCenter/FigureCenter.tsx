...
type FigureTab = 'generative' | 'structural' | 'assembly' | 'summary' | 'timeline' | 'tree' | 'audit' | 'sankey';
const VALID_TABS: FigureTab[] = ['generative', 'structural', 'assembly', 'summary', 'timeline', 'tree', 'audit', 'sankey'];
