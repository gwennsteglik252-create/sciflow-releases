        ...
        <div className="grid grid-cols-4 gap-2">
          {[
            ...
            <button
              ...
              className={`py-1 rounded-lg text-[8px] font-black transition-all border ${aspectRatio === ratio.val ? 'bg-indigo-600 text-white border-indigo-600' : 'bg-slate-50 text-slate-400 border-slate-200 hover:border-indigo-300'}`}
            >
              {ratio.label}
            </button>
          ))}
