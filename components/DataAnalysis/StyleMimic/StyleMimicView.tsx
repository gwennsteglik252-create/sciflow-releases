...
const StyleMimicView: React.FC = () => {
    ...
    const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            ...
            setState(prev => ({ ...prev, targetImage: url }));
        }
    };
                ...
                <div className="col-span-3 bg-white/80 backdrop-blur-md rounded-[2.5rem] border border-slate-200 p-6 flex flex-col shadow-sm gap-6">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-5 gap-2 mb-3">
                            {activeConfig.palette.map((color, idx) => (
                                <button
                                    key={idx}
                    ...
                    <button onClick={handleSaveTemplate} className="mt-auto w-full py-3 bg-white border border-slate-200 text-slate-600 rounded-xl text-[10px] font-black uppercase hover:bg-pink-50 hover:text-pink-600 hover:border-pink-200 transition-all shadow-sm">
