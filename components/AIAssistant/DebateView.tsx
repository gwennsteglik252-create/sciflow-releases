    ...
    <div className="flex-1 flex flex-col min-h-0 bg-slate-900 text-white relative">
      <header className="px-8 py-6 border-b border-white/5 flex justify-between items-center shrink-0">
          <div className="flex items-center gap-4">
             ...
             <div>
                <h3 className="text-xl font-black uppercase italic tracking-tighter">科研委员会多维质询 (COLLOQUIUM)</h3>
                <p className="text-[8px] font-black text-slate-500 uppercase tracking-[0.2rem] mt-1">Multi-Agent Conflict Resolution Mode</p>
             </div>
          </div>
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto p-10 custom-scrollbar space-y-12">
        {!session.isComplete && !isDebating && session.messages.length === 0 ? (
            <div className="max-w-2xl mx-auto flex flex-col items-center justify-center h-full text-center py-20">
                ...
                <h4 className="text-2xl font-black text-slate-400 uppercase italic mb-4">设定辩论命题</h4>
                <p className="text-sm text-slate-500 mb-10 leading-relaxed italic">请输入您想要质询的研究假设或项目方案，专家委员会将从严谨性、创新性及传统理论等多个维度发起交叉质询。</p>
                ...
                <div className="w-full relative group">
                    <textarea 
                        ...
                        placeholder="在此输入您的科研 Proposition..."
                        value={proposition}
            ...
            <div className="max-w-4xl mx-auto space-y-12 pb-32">
                ...
                <div className="bg-white/5 border border-white/10 rounded-[2rem] p-8 relative overflow-hidden">
                    ...
                    <p className="text-[10px] font-black text-amber-500 uppercase tracking-widest mb-2">待质询命题 (PROPOSITION)</p>
                ...
                {isDebating && (
                    <div className="flex justify-center py-10 animate-pulse">
                        <div className="flex items-center gap-4 bg-white/5 border border-white/10 px-8 py-4 rounded-full">
                            ...
                            <span className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3rem]">专家正在进行多维交叉质询中...</span>
                        </div>
                    </div>
                )}
                    ...
                    <div className="bg-gradient-to-br from-indigo-900 to-slate-900 border-2 border-indigo-500/30 rounded-[3rem] p-10 shadow-[0_25px_60px_rgba(0,0,0,0.5)] animate-reveal relative overflow-hidden">
                        ...
                        <header className="flex justify-between items-center mb-8 relative z-10">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h4 className="text-2xl font-black uppercase italic tracking-tighter text-white">辩论共识备忘录</h4>
                                    <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mt-1">Scientific Committee Consensus</p>
                                </div>
                            </div>
                            <div className="flex flex-col items-end">
                                <span className="text-[8px] font-black text-slate-500 uppercase mb-1">FINAL VERDICT</span>
                        ...
                        <div className="space-y-8 relative z-10">
                            <div className="bg-white/5 p-6 rounded-3xl border border-white/5">
                                <h5 className="text-[10px] font-black text-indigo-300 uppercase tracking-widest mb-3">核心冲突与权衡 (SUMMARY)</h5>
                                <p className="text-[13px] font-medium leading-relaxed text-slate-200 italic">{consensus.summary}</p>
                            </div>

                            <div className="space-y-4">
                                <h5 className="text-[10px] font-black text-emerald-400 uppercase tracking-widest px-2">下一步改进项 (ACTION ITEMS)</h5>
                        ...
                        <div className="mt-10 pt-6 border-t border-white/10 flex justify-between items-center opacity-40">
                             <p className="text-[8px] font-black text-slate-500 uppercase">Verification Code: SF-DEBATE-SYNC-712</p>
                             <button onClick={runFullDebate} className="text-[9px] font-black text-indigo-400 hover:text-white transition-colors uppercase"><i className="fa-solid fa-rotate-right mr-2"></i> 重新推演</button>
                        </div>
                    </div>
                )}
            </div>
