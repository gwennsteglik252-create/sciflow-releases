  ...
  return (
    <div className="w-72 bg-slate-50 border-r border-slate-200 flex flex-col p-5 shrink-0">
      <div className="flex items-center gap-3 mb-6 px-1">
        ...
        <h3 className="text-sm font-black text-slate-800 uppercase tracking-wider">项目素材库</h3>
      </div>
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar space-y-3 pr-1">
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-[9px] text-slate-400 truncate mt-0.5">
                  {media.description ? (media.description.includes('[Analysis]') ? '含深度解析' : media.description) : "暂称图注"}
                </p>
        ...
        {projectMedia.length === 0 && <p className="text-slate-400 text-[10px] text-center italic py-10">暂无图片素材</p>}
      </div>
    </div>
  );
};
