      ...
      `}</style>
            ...
            {logic.showLibrary && (
                <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-md z-[3000] flex items-center justify-center p-4">
                    <div className="bg-white w-full max-w-lg rounded-[1.5rem] p-8 animate-reveal shadow-2xl relative flex flex-col max-h-[80vh]">
            ...
            {logic.showSaveModal && (
                <div className="fixed inset-0 bg-slate-950/80 backdrop-blur-md z-[3000] flex items-center justify-center p-4">
                    <div className="bg-white w-full max-w-md rounded-[1.5rem] p-8 animate-reveal shadow-2xl relative border-4 border-white">
            ...
            {showSyncToLogModal && (
                <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-slate-950/80 backdrop-blur-sm">
                    <div className="bg-white w-full max-w-md rounded-[1.5rem] p-8 animate-reveal shadow-2xl relative border-4 border-white/50">
