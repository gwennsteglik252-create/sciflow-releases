            ...
            <div className="flex-1 overflow-y-auto p-5 space-y-4 custom-scrollbar bg-white">
                {activeTab === 'overview' && (
                    <div className="space-y-4 animate-reveal">
                        {/* ΔE Core Card */}
                        <div className={`${rCfg.bg} ${rCfg.border} border-2 rounded-[1.2rem] p-5 relative overflow-hidden`}>
                ...
                {activeTab === 'radar' && (
                    <div className="space-y-4 animate-reveal">
                        <div className="bg-white p-4 rounded-[1.2rem] border border-slate-200 shadow-lg">
                        ...
                        <div className="bg-slate-50 rounded-[1.2rem] p-4 border border-slate-100">
                ...
                {activeTab === 'kinetics' && (
                    <div className="space-y-4 animate-reveal">
                        {/* ORR Kinetics */}
                        <div className="bg-indigo-50/50 p-5 rounded-[1.2rem] border border-indigo-100">
                        ...
                        {/* OER Kinetics */}
                        <div className="bg-orange-50/50 p-5 rounded-[1.2rem] border border-orange-100">
                        ...
                        <div className="bg-slate-900 rounded-[1.2rem] p-5 text-white relative overflow-hidden">
                ...
                {activeTab === 'stability' && (
                    <div className="space-y-4 animate-reveal">
                        <div className="p-5 bg-rose-50/50 rounded-[1.2rem] border border-rose-100">
                        ...
                        <div className="bg-white p-4 rounded-[1.2rem] border border-slate-200">
