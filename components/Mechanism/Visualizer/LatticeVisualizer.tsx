        ...
        <div className="absolute top-4 right-4 z-20">
          ...
          {isMofOrSac && (
            <button
              ...
              title={isUnfolded ? t('mechanism.visualizer.latticeRollBack') : t('mechanism.visualizer.latticeUnfold')}
            >
            ...
            <div className="mt-2 flex gap-1.5">
              {(['OER', 'ORR'] as const).map(type => (
                <button key={type} onClick={() => toggleReaction(type)}
                  ...
                  title={`${type === 'OER' ? t('mechanism.visualizer.latticeOERDemo') : t('mechanism.visualizer.latticeORRDemo')}`}
                >
