...
export const FlowchartInput: React.FC<FlowchartInputProps> = ({
  ...
  return (
    <div className="w-80 lg:w-96 shrink-0 h-full flex flex-col gap-4 overflow-hidden no-print">
      <div className="bg-white/95 backdrop-blur-xl p-6 rounded-[2.5rem] border border-slate-200 flex flex-col h-full overflow-hidden shadow-2xl relative group">
        <div className="flex flex-col gap-4 mb-6 relative z-10">
          ...
          <div className="grid grid-cols-12 gap-2 px-1 px-1">
            <button
              ...
              className="col-span-5 flex items-center justify-center gap-2 bg-white border border-slate-200 text-indigo-600 px-3 py-2.5 rounded-2xl text-[9px] font-black uppercase shadow-sm hover:shadow-md hover:border-indigo-400 hover:text-indigo-700 transition-all active:scale-95 disabled:opacity-50 group/btn"
            ...
            <div className="col-span-4 flex bg-slate-100/80 p-1 rounded-2xl border border-slate-200/50 shadow-inner relative overflow-hidden">
              <div
            ...
            <div className="col-span-3 flex items-center bg-white text-slate-800 rounded-2xl border border-slate-200 shadow-sm overflow-hidden relative">
              <button
        ...
        <div className="flex-1 w-full bg-slate-50/50 p-4 rounded-2xl border border-slate-100 mb-4 shadow-inner relative flex flex-col">
          <textarea
        ...
        <button
          ...
          className={`w-full py-4 rounded-2xl text-[10px] font-black shadow-xl uppercase tracking-[0.1rem] flex items-center justify-center gap-2 transition-all group ${isGenerating
